		...
		init : function() {
			...
			if (s.theme) {
				...
				if (t.theme.init && s.init_theme){
                                    t.theme.init(t, AJS.contextPath() + "/download/resources/com.ideotechnologies.jira.tinymce-renderer-plugin:tinymce-renderer/themes/" + s.theme);
                                }
                                    
			}
			function initPlugin(p) {
				var c = PluginManager.get(p)
                                var u = AJS.contextPath() +"/download/resources/com.ideotechnologies.jira.tinymce-renderer-plugin:tinymce-renderer/plugins/" + p
                                var po;
			...
			if (s.popup_css !== false) {
				if (s.popup_css){
                                       ...
                                       s.popup_css = t.baseURI.toAbsolute(AJS.contextPath() + "/download/resources/com.ideotechnologies.jira.tinymce-renderer-plugin:tinymce-renderer/themes/" + s.theme + "/skins/" + s.skin + "/dialog.css");
                                }
